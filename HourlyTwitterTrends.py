...
# MAGIC %sql select * from tweets.`bronze`;
...
# MAGIC %sql select * from tweets.`silver` order by createdAt desc limit 10;
...
# MAGIC %sql
# MAGIC 
# MAGIC select * from tweets.`gold` order by date, hour, count desc;
